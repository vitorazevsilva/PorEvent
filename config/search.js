$( document ).ready(function() {
  console.log( "ready!" );
  $('#filter_date').val('');
  if(sessionStorage.getItem('distrito')!=null || sessionStorage.getItem('tipoevento')!=null){
    document.getElementById("cb_distrito").value = sessionStorage.getItem('distrito');
    document.getElementById("cb_tipoevento").value = sessionStorage.getItem('tipoevento');
    getconcelho();
  }
...
function query(){
  ...
  function getconcelho(){
    ...
    var distrito=sessionStorage.getItem('distrito');
    ...
    if(distrito!="Todos os Distrito" && distrito!="Madeira" && distrito!="Açores"){
      ...
      request.done(function(data) {
              ...
              if(data.length>0){
                  ...
                  document.getElementById("cb_concelhos").value = sessionStorage.getItem('concelho');
              }    
      }); 
  }
...
function search(){
    ...
    var cb_concelho = sessionStorage.getItem('concelho');
    ...
    where="";
      if(data!=""){
        ...
        where=where+'Datafim>= Date(Now()) AND ' ;
